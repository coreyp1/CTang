...
#ifndef GHOTI_IO_GTA_AST_ASTNODE_H
#define GHOTI_IO_GTA_AST_ASTNODE_H
 ...
 * @return True on success, false on failure.
 */
GTA_API bool gta_ast_node_compile_to_binary__arm_64(GTA_Ast_Node * self, GTA_Compiler_Context * context);
 ...
 * @return True on success, false on failure.
 */
GTA_API bool gta_ast_node_compile_to_binary__x86_32(GTA_Ast_Node * self, GTA_Compiler_Context * context);
 ...
 * @return True on success, false on failure.
 */
GTA_API bool gta_ast_node_compile_to_binary__arm_32(GTA_Ast_Node * self, GTA_Compiler_Context * context);
...
#endif //GHOTI_IO_GTA_AST_ASTNODE_H
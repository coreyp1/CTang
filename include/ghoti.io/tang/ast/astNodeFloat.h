...
#ifndef GHOTI_IO_GTA_AST_ASTNODEFLOAT_H
#define GHOTI_IO_GTA_AST_ASTNODEFLOAT_H
 ...
 */
GTA_API extern GTA_Ast_Node_VTable gta_ast_node_float_vtable;
 ...
 */
GTA_API GTA_NO_DISCARD GTA_Ast_Node_Float * gta_ast_node_float_create(GCU_float64_t float64, GTA_PARSER_LTYPE location);
 ...
 */
GTA_API void gta_ast_node_float_destroy(GTA_Ast_Node * self);
 ...
 */
GTA_API void gta_ast_node_float_print(GTA_Ast_Node * self, const char * indent);
 ...
 */
GTA_API GTA_NO_DISCARD GTA_Ast_Node * gta_ast_node_float_simplify(GTA_Ast_Node * self, GTA_Ast_Simplify_Variable_Map * variable_map);
 ...
 */
GTA_API void gta_ast_node_float_walk(GTA_Ast_Node * self, GTA_Ast_Node_Walk_Callback callback, void * data, void * return_value);
 ...
 */
GTA_API bool gta_ast_node_float_compile_to_binary__x86_64(GTA_Ast_Node * self, GTA_Compiler_Context * context);
 ...
 */
GTA_API bool gta_ast_node_float_compile_to_bytecode(GTA_Ast_Node * self, GTA_Compiler_Context * context);

#ifdef __cplusplus
}
#endif //__cplusplus

#endif //GHOTI_IO_GTA_AST_ASTNODEFLOAT_H
...
#ifndef GHOTI_IO_GTA_LIBRARY_LIBRARY_H
#define GHOTI_IO_GTA_LIBRARY_LIBRARY_H
 ...
 */
GTA_API GTA_NO_DISCARD GTA_Library * GTA_CALL gta_library_create(void);
 ...
 */
GTA_API bool GTA_CALL gta_library_create_in_place(GTA_Library * library);
 ...
 */
GTA_API void GTA_CALL gta_library_destroy(GTA_Library * library);
 ...
 * @param library The library object to destroy.
 */
GTA_API void GTA_CALL gta_library_destroy_in_place(GTA_Library * library);
 ...
 * @return true on success, false on failure.
 */
GTA_API bool GTA_CALL gta_library_add_library_from_hash(GTA_Library * library, GTA_UInteger hash, GTA_Library_Callback func);
 ...
 * @return true on success, false on failure.
 */
GTA_API bool GTA_CALL gta_library_add_library_from_string(GTA_Library * library, const char * identifier, GTA_Library_Callback func);
 ...
 */
GTA_API GTA_Library_Callback GTA_CALL gta_library_get_library(GTA_Library * library, GTA_UInteger hash);
 ...
 * @return The callback function, or NULL on failure.
 */
GTA_API GTA_Library_Callback GTA_CALL gta_library_get_from_context(GTA_Execution_Context * context, GTA_UInteger hash);
...
#endif // GHOTI_IO_GTA_LIBRARY_LIBRARY_H

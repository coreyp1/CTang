 ...
 */
GTA_Ast_Node_Float * gta_ast_node_float_create(GCU_float64_t float64, GTA_PARSER_LTYPE location);
 ...
 */
GTA_Ast_Node * gta_ast_node_float_simplify(GTA_Ast_Node * self, GTA_Ast_Simplify_Variable_Map * variable_map);
